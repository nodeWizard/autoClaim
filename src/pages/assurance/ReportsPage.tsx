...
import { reportsFromClaims } from '@/data/mock/reports'
...
export function ReportsPage() {
  ...
  const reports = reportsFromClaims(claims)
    ...
    <div>
      ...
      {reports.length === 0 ? (
        <p className="rounded-xl border border-dashed p-10 text-center text-muted-foreground">
          Aucun rapport pour le moment. Lancez une analyse IA sur un dossier.
        </p>
      ) : (
